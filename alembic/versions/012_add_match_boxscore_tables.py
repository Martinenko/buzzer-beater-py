...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("match_id", sa.Integer(), sa.ForeignKey("match_boxscore.match_id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_index("ix_match_team_boxscore_match_id", "match_team_boxscore", ["match_id"])
    ...
    op.create_index("ix_match_player_boxscore_match_id", "match_player_boxscore", ["match_id"])
    op.create_index("ix_match_player_boxscore_player_id", "match_player_boxscore", ["player_id"])


def downgrade() -> None:
    op.drop_index("ix_match_player_boxscore_player_id", table_name="match_player_boxscore")
    op.drop_index("ix_match_player_boxscore_match_id", table_name="match_player_boxscore")
    op.drop_table("match_player_boxscore")
    op.drop_index("ix_match_team_boxscore_match_id", table_name="match_team_boxscore")
    op.drop_table("match_team_boxscore")
    op.drop_table("match_boxscore")
